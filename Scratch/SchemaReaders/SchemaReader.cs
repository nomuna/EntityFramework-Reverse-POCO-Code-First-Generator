...
namespace Scratch.SchemaReaders
{
    public abstract class SchemaReader
    {
        ...
        protected void ProcessForeignKeys(List<ForeignKey> fkList, Tables tables, bool checkForFkNameClashes)
        {
        ...
        protected void IdentifyForeignKeys(List<ForeignKey> fkList, Tables tables)
        {
        ...
        private Column CreateColumn(IDataRecord rdr, Table table)
        {
            ...
            var titleCase =
                (Settings.UsePascalCase ? Inflector.ToTitleCase(col.NameHumanCase) : col.NameHumanCase).Replace(" ", "");
